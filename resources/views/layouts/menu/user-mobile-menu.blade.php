<div class="lg:hidden" x-show="isMobileMenuOpen" x-transition:enter="transition ease-out duration-100 transform"
    ...
    <div class="space-y-1 px-2 pb-3 pt-2">
        ...
        <a href="#"
            class="text-white hover:bg-indigo-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">Accounts</a>
        <a href="#"
            class="text-white hover:bg-indigo-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">Categories</a>
    </div>
